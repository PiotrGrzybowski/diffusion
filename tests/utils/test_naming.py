...
class TestGenerateRunName:
    ...
    def test_generation_with_hybrid_loss(self, tmp_path):
        ...
        name = generate_run_name(choices, "cifar10", tmp_path, append_timestamp_on_collision=False)
...
class TestAutoGenerateNames:
    ...
    def test_auto_generate_both_names(self, mock_hydra_config, tmp_path):
    ...
    @patch("diffusion.utils.naming.HydraConfig")
    def test_respects_explicit_names(self, mock_hydra_config, tmp_path):
    ...
    @patch("diffusion.utils.naming.HydraConfig")
    def test_debug_mode(self, mock_hydra_config, tmp_path):
    ...
    @patch("diffusion.utils.naming.HydraConfig")
    def test_debug_mode_respects_explicit_run_name(self, mock_hydra_config, tmp_path):
