...
class Trainer:
    def __init__(
        ...
        *,
        ...
        ) >= 16, "your effective batch size (train_batch_size x gradient_accumulate_every) should be at least 16 or above"
            ...
            while self.step < self.train_num_steps:
                ...
                if accelerator.is_main_process:
                    ...
                    if self.step != 0 and divisible_by(self.step, self.save_and_sample_every):
                        ...
                        utils.save_image(
                            all_images, str(self.results_folder / f"sample-{milestone}.png"), nrow=int(math.sqrt(self.num_samples))
                        )
...
if __name__ == "__main__":
    ...
    # # trainer
    #
    # trainer = Trainer(diffusion, folder="path/to/your/images", train_num_steps=10000)
    #
    # # training
    #
    # trainer.train()
